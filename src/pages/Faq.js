    ...
    <div className="FaqPage">
      ...
      <div className="container">
        ...
        <div className="content-wrapper">
          ...
          <p>TasteTravel allows you to interactively explore recipes from the countries of the world. It caters to your food preferences and matches you with a recipe from a country of your choice. This is done by allowing you to initially specify your food preferences and allergies. TasteTravel then provides you with an interactive world map where you can choose the country of interest. Through the preferences listed and a match-making algorithm, you will then be presented with a recipe from that country. </p>
          <br></br>
